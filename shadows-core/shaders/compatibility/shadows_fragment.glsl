...
// Shadow map resolution (must match settings.cfg or be lower for more blurriness)
#ifndef SHADOWMAP_RES
#define SHADOWMAP_RES 256.0
#endif

// Penumbra width scaling (pseudo-PCSS)
// Scales filter radius based on depth in shadow map
// PENUMBRA_NEAR: filter scale when close to shadow caster (contact shadows)
// PENUMBRA_FAR: filter scale when far from shadow caster (wide soft shadows)
...
// Set to 0 to disable distance-based penumbra scaling
...
// ============================================================================
// Spiral Disc Sampler (Jimenez SIGGRAPH 2014)
// 8-tap spiral with alternating flip - optimized for IGN rotation
// ============================================================================
