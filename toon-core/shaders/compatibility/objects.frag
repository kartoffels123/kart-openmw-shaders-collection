...
#include "lib/light/lighting_toon.glsl"
...
vec2 screenCoords = gl_FragCoord.xy / screenRes;
...
#if @diffuseMap
    gl_FragData[0] = toonTexture2D(diffuseMap, diffuseMapUV + offset);
    ...
    // Flatten texture contrast for illustrated/painted look
    gl_FragData[0].xyz = flattenTexture(gl_FragData[0].xyz);
